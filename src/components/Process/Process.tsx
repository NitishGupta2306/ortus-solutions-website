  ...
  return (
    <div className="h-full w-full [perspective:1000px]">
      ...
      >
        ...
        >
          <Card glass className="h-full shadow-xl relative">
            {/* Step Number Badge */}
            <div className="absolute -top-3 -left-3 w-10 h-10 rounded-full bg-gradient-to-br from-accent to-accent-light flex items-center justify-center text-white font-bold text-lg shadow-lg">
              {index + 1}
            </div>
            ...
            <div className="flex flex-col items-center justify-center h-full text-center pointer-events-none p-6">
              {/* Icon */}
              <div className="mb-4">
                <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-accent to-accent-light flex items-center justify-center shadow-lg">
  ...
  return (
    <Section id="process" background="white">
      <Container>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8" style={{ gridAutoRows: '280px' }}>
