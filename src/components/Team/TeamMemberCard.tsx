...
export const TeamMemberCard = memo(function TeamMemberCard({ member }: TeamMemberCardProps) {
  ...
  // Professional blue gradients for different cards
  const gradients = [
  ...
  const gradient = gradients[member.name.length % gradients.length]
  ...
  return (
    <div className="h-full w-full [perspective:1000px] group">
      ...
      >
        ...
        >
          <div className="h-full bg-white dark:bg-slate-800 rounded-2xl shadow-lg border-2 border-transparent hover:border-accent/50 transition-all overflow-visible flex flex-col">
            <div className="flex flex-col h-full pointer-events-none pt-20">
              ...
              <div className="flex flex-col flex-1 px-6 pb-6">
                ...
                <div className="text-center mb-3 flex-shrink-0">
                  ...
                  <p className={`bg-gradient-to-r ${gradient} bg-clip-text text-transparent font-bold text-sm`}>
                    {member.title}
                  </p>
                </div>

                {/* Tagline */}
                <p className="text-slate-600 dark:text-slate-300 text-sm text-center mb-4 italic flex-shrink-0 leading-snug">
                  "{member.tagline}"
                </p>
        ...
        >
          <div className="h-full bg-white dark:bg-slate-800 rounded-2xl shadow-lg border-2 border-accent/30 p-6 overflow-hidden flex flex-col">
            {/* Gradient header bar */}
